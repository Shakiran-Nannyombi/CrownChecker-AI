    ...
    >
      ...
      >
        <div
          ...
          style={{ background: 'radial-gradient(circle 900px at 50% 0%, color-mix(in srgb, var(--color-primary-container) 50%, transparent), transparent)' }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-24 flex flex-col md:flex-row items-end gap-12">
      ...
      <main className="pb-40 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {tiers.map((tier) => (
            <div
              key={tier.name}
              className={`relative rounded-xl p-10 flex flex-col transition-all duration-500 ${tier.featured
                ? "bg-linear-to-br from-primary to-primary-container shadow-2xl scale-105 z-10 hover:scale-[1.07]"
            ...
            >
              ...
              <ul className="space-y-6 grow mb-12">
              ...
              <button className={`w-full py-4 rounded-xl font-sans font-bold transition-all ${tier.featured
